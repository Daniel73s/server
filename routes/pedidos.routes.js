...
const { getAllPedidosByColegio, getPedidosByColegioAndFecha, getPedidosByProveedorAndFecha, postPedido, postDetallePedido, deleteDetallePedido, deletePedido, fullDetallePedido, getPedidosByProveedor, modificarEstadoPedido, getAllPedidos } = require('../controllers/pedidos.controller');
const router = Router();
